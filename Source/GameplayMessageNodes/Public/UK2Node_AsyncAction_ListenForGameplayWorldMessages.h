...
#include "UK2Node_AsyncAction_ListenForGameplayWorldMessages.generated.h"
...
/**
 * Blueprint node which is spawned to handle the async logic for UAsyncAction_ListenForGameplayWorldMessage
 */

UCLASS()
class GAMEPLAYMESSAGENODES_API UK2Node_AsyncAction_ListenForGameplayWorldMessages : public UK2Node_AsyncAction
{
	GENERATED_BODY()
